<template>
  ...
  <div class="layout">
    <!-- картина дня -->
    <div class="main">
      <div v-if="true || mainPageWidgets.superAnnounce.data.primary">
      ...
      <div class="layout">
        <div class="main grid">
          <div class="grid-col grid-col-s3">
            <!-- топ -->
            <TopNews :topNewsData="mainPageWidgets.top"/>

            <div class="hide_mobile">
              <!-- яркое пятно -->
              <LightSpot :lightSpotData="mainPageWidgets.lightSpot"/>
            </div>
          </div>
          ...
          <div v-if="true || mainPageWidgets.superAnnounce.data.secondary">
      ...
      <!-- главное -->
      <div class="layout">
        <MainToday :main-today-data="mainPageWidgets.mainToday"/>
      </div>

      <!-- мнения -->
      <div class="layout">
        <Opinions :opinions-data="mainPageWidgets.opinions"/>
      </div>
      ...
      <div class="layout">
        <div class="main grid">
          <div class="grid-col grid-col-s3">
            ...
            <template v-if="index < 3" v-for="(rubric, index) in mainPageWidgets.rubrics.data.rubrics">
      ...
      <div class="layout">
        <div class="main grid">
          <div class="grid-col grid-col-s3">
            ...
            <template v-if="index >=3 && index < 7" v-for="(rubric, index) in mainPageWidgets.rubrics.data.rubrics">
              <Rubric :rubric-data="rubric"/>
            </template>
      ...
      <div class="layout">
        <div class="main grid">
          <div class="grid-col grid-col-s3">
            ...
            <template v-if="index >=7 && index < 9" v-for="(rubric, index) in mainPageWidgets.rubrics.data.rubrics">
              <Rubric :rubric-data="rubric"/>
            </template>
            ...
            <template v-if="index >=9 && index < 11" v-for="(rubric, index) in mainPageWidgets.rubrics.data.rubrics">
              <Rubric :rubric-data="rubric"/>
            </template>
      ...
      <div class="layout">
        <div class="main">
          <!-- провести время -->
          <SpendTime :spend-time-data="mainPageWidgets.spendTime"/>
        </div>
      </div>
