<template>
  ...
  <div class="multimedia__slider slider slider-commercial">
    <div
          ...
          <div class="spend__text">
            ...
            <h2 class="spend__name">
              <a
                ...
                class="spend__link link link_overlay slider-link">Как сделать офисное пространство безопаснее</a>
            </h2>
            <h3 class="spend__subheader">
              <a
                href="https://special.kommersant.ru/budu/office.html?utm_source=kommersant&amp;utm_medium=partner&amp;utm_campaign=renaissance "
                class="spend__link slider-link">Короткий список советов</a>
            </h3>
          </div>
        </article>
      </div>
