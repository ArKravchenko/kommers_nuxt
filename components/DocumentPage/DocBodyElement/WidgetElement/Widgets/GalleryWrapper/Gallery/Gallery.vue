<template>
  ...
  <div class="doc_media slider slider-gallery">
    ...
    <div class="doc_media__canvas slider-canvas">
      <template v-if="getGalleryItems">
        <div class="doc_media__item slider-item"
    ...
    <div v-if="getGalleryItems"
      class="doc_media__counter slider-gallery-number">
...
<script src="./Gallery.ts" lang="ts"></script>
