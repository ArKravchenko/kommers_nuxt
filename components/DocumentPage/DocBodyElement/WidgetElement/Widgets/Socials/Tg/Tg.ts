...
@Component({
  // name is required for recursive components as Tg uses DocBodyElement and vice versa
  name: 'Tg',
  components: {
    // HtmlTagElement,
  }
})
export default class Tg extends Vue {
  @Prop({
    // type: Object,
    // required: true,
    default: null,
  ...
  mounted() {
    this.runScripts()
    // console.log('this.socialsWidgetData TG',this.socialsWidgetData)
  };
};
